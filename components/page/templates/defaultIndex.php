...
<section id="intro" class="container-fluid">
    <div class="row demo-bg">
        <div class="col-md-6 col-md-offset-1">
            <div class="alpha60 intro-quote vertical-offset-7">
...
<!-- Features -->
<section id="features" class="container-fluid gray_back_div">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 feature">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9 feature_desc"><h4><b>Advanced Routing System</b></h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 feature">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9 feature_desc"><h4><b>Built-in User Authentication</b></h4>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 feature">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9 feature_desc"><h4><b>Built-in Inputs Validator</b></h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 feature">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9 feature_desc"><h4><b>Multilingual Support</b></h4>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 feature">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9 feature_desc"><h4><b>Pure PHP Template Engine</b></h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 feature">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-9 feature_desc"><h4><b>Handy Utility Classes</b></h4>
                        <p>There are utility classes to add more juice to default PHP functions.</p>
                    </div>
                </div>
            </div>
        </div>
